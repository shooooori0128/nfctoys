<template>
  <div>
    ...
    <v-layout align-center justify-center column fill-height>
      ...
      <v-flex xs-12>
        <v-btn large icon color="red lighten-4" @touchStart="recStart()" @touchEnd="isShowBaseConfirmDialog = true">
  ...
  >
    <span>今話した内容をNFCタグに記録します。よろしいですか？</span>
  </base-confirm-dialog>
  </div>
</template>
...
import BaseConfirmDialog from "packs/components/BaseConfirmDialog.vue";
